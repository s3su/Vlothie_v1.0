...
function Controller() {
    ...
    $.__views.articleWindow.add($.__views.windowButtons);
    ...
    $.__views.windowButtons.add($.__views.__alloyId0);
    ...
    $.__views.articleWindow.add($.__views.windowTitle);
    $.__views.articleTitleText = Ti.UI.createLabel({
        color: "#922a80",
        font: {
            fontSize: "20dp",
            fontWeight: "bold",
    ...
    $.__views.windowTitle.add($.__views.articleTitleText);
    ...
    $.__views.__alloyId3.add($.__views.articleSelectedImg);
