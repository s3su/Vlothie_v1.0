...
function Controller() {
    ...
    $.__views.getLook.add($.__views.__alloyId8);
    ...
    showLooksWithSituation1 ? $.__views.__alloyId10.addEventListener("click", showLooksWithSituation1) : __defers["$.__views.__alloyId10!click!showLooksWithSituation1"] = true;
    ...
    showLooksWithSituation2 ? $.__views.__alloyId12.addEventListener("click", showLooksWithSituation2) : __defers["$.__views.__alloyId12!click!showLooksWithSituation2"] = true;
    ...
    showLooksWithSituation3 ? $.__views.__alloyId14.addEventListener("click", showLooksWithSituation3) : __defers["$.__views.__alloyId14!click!showLooksWithSituation3"] = true;
    ...
    showLooksWithSituation4 ? $.__views.__alloyId16.addEventListener("click", showLooksWithSituation4) : __defers["$.__views.__alloyId16!click!showLooksWithSituation4"] = true;
    ...
    showHome ? $.__views.__alloyId19.addEventListener("click", showHome) : __defers["$.__views.__alloyId19!click!showHome"] = true;
    ...
    showTrends ? $.__views.__alloyId20.addEventListener("click", showTrends) : __defers["$.__views.__alloyId20!click!showTrends"] = true;
...
<<<<<<< HEAD
    ...
    __defers["$.__views.__alloyId16!click!showLooksWithSituation4"] && $.__views.__alloyId16.addEventListener("click", showLooksWithSituation4);
