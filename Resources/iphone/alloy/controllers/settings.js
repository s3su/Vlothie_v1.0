...
function Controller() {
    ...
    showAlarm ? $.__views.__alloyId43.addEventListener("click", showAlarm) : __defers["$.__views.__alloyId43!click!showAlarm"] = true;
    ...
    showSettings ? $.__views.__alloyId44.addEventListener("click", showSettings) : __defers["$.__views.__alloyId44!click!showSettings"] = true;
    ...
    __defers["$.__views.__alloyId43!click!showAlarm"] && $.__views.__alloyId43.addEventListener("click", showAlarm);
    __defers["$.__views.__alloyId44!click!showSettings"] && $.__views.__alloyId44.addEventListener("click", showSettings);
    _.extend($, exports);
}
